        ...
        <div className="space-y-5">
          ...
          {!selectedCard ? (
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {cards.map((card) => <CreditCardPanel key={card.id} card={card} currentInvoice={getCurrentInvoice(card, invoices)} onArchive={requestArchiveCard} onEdit={openCardForm} onPurchase={openPurchase} />)}
...
function CreditCardPanel({ card, compact = false, currentInvoice, onArchive, onEdit, onPurchase }: {
  card: CreditCardType;
  compact?: boolean;
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="grid grid-cols-3 gap-2 border-t border-slate-100 p-3 dark:border-slate-800">
...
function CardDetail({ accounts, activeTab, card, categories, installments, invoiceViews, invoices, onArchive, onEditCard, onEditPurchase, onPayInvoice, onPurchase, onRemoveInvoice, onRemovePayment, onRemovePurchase, onTabChange, onViewChange, payments, purchases }: {
  accounts: Account[];
  activeTab: CardTab;
  card: CreditCardType;
  categories: Category[];
  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[340px_minmax(0,1fr)]">
      <div className="space-y-3">
        <CreditCardPanel card={card} compact currentInvoice={currentInvoice} onArchive={onArchive} onEdit={onEditCard} onPurchase={onPurchase} />
